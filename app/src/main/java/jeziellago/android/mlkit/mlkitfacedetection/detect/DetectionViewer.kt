...
internal class DetectionViewer(private val cameraWidth: Int,
                               ...
                               private val enableContours: Boolean = false) {
            ...
            if (enableContours) {
                ...
                with(it) {
                    val detectedFace = DetectedFace(
                            ...
                            leftMouth = getLandmark(FirebaseVisionFaceLandmark.MOUTH_LEFT),
                            rightMouth = getLandmark(FirebaseVisionFaceLandmark.MOUTH_RIGHT),
                            bottomMouth = getLandmark(FirebaseVisionFaceLandmark.MOUTH_BOTTOM),
